        ...
        <div className="md:flex md:justify-between mx-4 lg:mx-28">
          <div>
            <div className="flex items-center w-full justify-between">
              <img src={Accountantlogo} alt="Logo" className="h-16 w-auto" />
          ...
          <div>
            <div className="md:flex items-center gap-4 w-full md:mt-0 mt-16">
              ...
              <div className="md:flex md:pt-0 gap-4">
                ...
                <a
                  ...
                  className="p-1 rounded-md bg-blue-500 shadow-lg hidden md:block" 
                >
