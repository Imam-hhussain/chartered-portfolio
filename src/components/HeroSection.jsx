...
function HeroSection() {
  ...
  return (
    <div>
      <div className="md:mt-12 mt-36 h-full">
      ...
      <div>
        <h1 className="text-white mt-3 text-md md:text-xl">
      ...
      <button className="font-bold mt-5 text-xl text-white border p-3 bg-blue-500 hover:bg-blue-600 hover:text-white transition rounded-md" onClick={()=>navigate('/contact-us')}>
        Contact Now
      </button>
    </div>
  );
